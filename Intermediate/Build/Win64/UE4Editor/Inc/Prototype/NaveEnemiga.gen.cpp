...
#include "Prototype/NaveEnemiga.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	PROTOTYPE_API UClass* Z_Construct_UClass_ANaveEnemiga_NoRegister();
	PROTOTYPE_API UClass* Z_Construct_UClass_ANaveEnemiga();
...
// End Cross Module References
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ANaveEnemiga_Statics::PropPointers[] = {
		...
		const UE4CodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_ANaveEnemiga_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_UPrototipoNaveEnemiga_NoRegister, (int32)VTABLE_OFFSET(ANaveEnemiga, IPrototipoNaveEnemiga), false },
		};
	...
	IMPLEMENT_CLASS(ANaveEnemiga, 2426345530);
	template<> PROTOTYPE_API UClass* StaticClass<ANaveEnemiga>()
	{
		return ANaveEnemiga::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_ANaveEnemiga(Z_Construct_UClass_ANaveEnemiga, &ANaveEnemiga::StaticClass, TEXT("/Script/Prototype"), TEXT("ANaveEnemiga"), false, nullptr, nullptr, nullptr);
